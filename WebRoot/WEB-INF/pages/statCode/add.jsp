...
<body>
    <div class="container">
        <form class="form-horizontal" action="addStatCode" method="post" role="form">
            <div class="form-group">
             
               
                <label for="ANC_TYP" class="col-sm-1">统计分析类别</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control" name="ANC_TYP" id="ANC_TYP" placeholder="统计分析类别">
                </div>
            ...
            <div class="form-group">
             <label for="ANC_CDE" class="col-sm-1">id</label>
             <div class="col-sm-3">
                    <input type="text" class="form-control" name="ANC_CDE" id="ANC_CDE" placeholder="id">
                </div>
