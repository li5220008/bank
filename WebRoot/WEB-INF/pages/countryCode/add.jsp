...
<body>
    <div class="container">
        <form class="form-horizontal" id="countryCodeForm" action="${pageContext.request.contextPath}/countryCode/addDo" method="post" role="form">
            <div class="form-group">
                <label for="country_code" class="col-sm-1">国家码</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control" name="country_code" id="country_code" placeholder="国家码">
                </div>

                <label for="country_name" class="col-sm-1">国家名称</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control" name="country_name" id="country_name" placeholder="国家名称">
                </div>

                <label for="allow_flag" class="col-sm-1">允许货币标志</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control" name="allow_flag" id="allow_flag" placeholder="允许货币标志">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control" name="currency" id="currency" placeholder="货币">
                </div>

                <label for="rate" class="col-sm-1">汇率</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control" name="rate" id="rate" placeholder="汇率">
                </div>
