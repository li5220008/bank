...
<div class="container">
    <form class="form-horizontal" id="countryCodeForm" action="${pageContext.request.contextPath}/countryCode/updateDo" method="post" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" class="form-control Wdate" onclick="WdatePicker()" value="<fmt:formatDate value='${countryCode.start_time}' pattern='yyyy-MM-dd' />" name="start_time" id="start_time" placeholder="启用日期">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" class="form-control Wdate" onclick="WdatePicker()" value="<fmt:formatDate value='${countryCode.last_time}' pattern='yyyy-MM-dd' />" name="last_time" id="last_time" placeholder="最后更新日期">
            </div>
