    ...
    <div class="container">
        <form class="form-horizontal" id="pifbusForm" action="${pageContext.request.contextPath}/pifbus/addDo" method="post" role="form">
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control" name="bus_cde" id="bus_cde" placeholder="业务码">
                </div>

                <label for="app_cde" class="col-sm-1">应用码</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control" name="app_cde" id="app_cde" placeholder="应用码">
                </div>

                <label for="bus_itm" class="col-sm-1">对应的核算科目号</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control" name="bus_itm" id="bus_itm" placeholder="对应的核算科目号">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control" name="bus_app" id="bus_app" placeholder="对应的应用码">
                </div>

                <label for="bus_nam" class="col-sm-1">业务描述</label>
                <div class="col-sm-3">
                    <textarea class="form-control" name="bus_nam" id="bus_nam" placeholder="业务描述" rows="3" ></textarea>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control" name="bus_kd2" id="bus_kd2" placeholder="业务小类">
                </div>
            </div>
